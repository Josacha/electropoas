import { db, auth } from "./firebase.js"; // Asegúrate de exportar 'auth' en firebase.js
import {
  collection,
  addDoc,
  getDocs,
  ...
  querySnapshot.forEach((docu) => {
    ...
    tabla.innerHTML += `
      <tr>
        ...
        <td>${p.categoria}</td>
        <td>
          <button onclick="editarProducto('${id}','${p.nombre}','${p.marca}','${p.categoria}','${p.voltaje}','${p.amperaje}','${p.imagen}','${p.descripcion}')">Editar</button>
